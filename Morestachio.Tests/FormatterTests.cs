...
namespace Morestachio.Tests
{
	...
	.  (   'd'  )
        ...
        public void TestSelect()
        {
            ...
            Assert.AreEqual(result, "2*3=6");
        }

        [Test]
        public void TestFormatterAsArgument()
        {
            var templateWorking = @"{{#data}}{{SomeValue3.Multiply('-1')}},{{SomeValue2.Multiply(SomeValue3.Multiply('-1'))}}{{/data}}";
