...
namespace Morestachio.Tests
{
	...
	.  (   'd'  )
        ...
        public void TemplateIfDoesNotScopeToRootWithFormatterCustomized()
        {
            ...
            parsingOptionsWorking.Formatters.AddSingle(new Func<string, bool>(f => f == "test"));
            var parsedTemplateWorking =
                Parser.ParseWithOptions(parsingOptionsWorking);
            ...
            var resultWorking = parsedTemplateWorking.Create(modelWorking).Stream.Stringify(true, ParserFixture.DefaultEncoding);
            ...
            Assert.AreEqual(resultWorking, result);
        }
