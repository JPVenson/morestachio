...
public class FileSystemFileService
{
	...
	[MorestachioFormatter(nameof(GetCreationTime),
	...
	[MorestachioFormatter(nameof(GetCreationTimeUtc),
	...
	[MorestachioFormatter(nameof(GetLastAccessTime),
	...
	[MorestachioFormatter(nameof(GetLastAccessTimeUtc),
	...
	[MorestachioFormatter(nameof(GetLastWriteTime),
	...
	[MorestachioFormatter(nameof(GetLastWriteTimeUtc),
	...
	[MorestachioFormatter(nameof(Move),
	...
	[MorestachioFormatter(nameof(ReadAllBytes),
	...
	[MorestachioFormatter(nameof(ReadAllText),
	...
	[MorestachioFormatter(nameof(ReadAllTextLines),
		"Opens a file, reads all lines of the file with the specified encoding, and then closes the file.")]
	public string[] ReadAllTextLines(string fileName,
									[FormatterValueConverter(typeof(EncodingConverter))] Encoding encoding = null)
	{
