...
namespace Morestachio.Formatter.Predefined
{
	...
	{
		[MorestachioFormatter("ParseTimeSpan", "Parses a string into a TimeSpan")]
		...
		[MorestachioFormatter("ParseTimeSpanExact", "Converts the string representation of a time interval to its TimeSpan equivalent by using the specified format and culture-specific format information.")]
