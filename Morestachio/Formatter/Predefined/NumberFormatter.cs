...
namespace Morestachio.Formatter.Predefined
{
	public static class NumberFormatter
	{
		...
		[MorestachioFormatter(">", "Returns if ether the value is bigger as the other")]
		public static Boolean BiggerAs([SourceObject]Int16 val1, Int16 val2) {
			return val1 > val2;
		}

		[MorestachioFormatter("<", "Returns if ether the value is smaller as the other")]
		public static Boolean SmallerAs([SourceObject]Int16 val1, Int16 val2) {
			return val1 < val2;
		}

		[MorestachioFormatter(">=", "Returns if ether the value is bigger or equal as the other")]
		public static Boolean BiggerOrEqualAs([SourceObject]Int16 val1, Int16 val2) {
			return val1 >= val2;
		}

		[MorestachioFormatter("<=", "Returns if ether the value is smaller or equal as the other")]
